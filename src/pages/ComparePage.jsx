...
export default function ComparePage() {
  usePageMeta(
    'CaptionScroll vs. BIGVU vs. PromptSmart Pro — Teleprompter Comparison',
    "Compare CaptionScroll's script-based caption embedding against BIGVU's auto-captions and PromptSmart Pro's voice tracking. See pricing, features, and who each app is best for."
  );
  ...
  return (
    <div className="site-page">
      ...
      <main className="legal-main compare-main">
        <h1>CaptionScroll vs. Other Teleprompter Apps</h1>

        <h2>CaptionScroll vs. BIGVU</h2>
        <p>
          ...
          contain transcription errors, just like YouTube&rsquo;s. CaptionScroll
          ...
          by AI guesswork. CaptionScroll also does not include full video
          editing — it is purpose-built for scripted, planned delivery.
        </p>

        <h2>CaptionScroll vs. PromptSmart Pro</h2>
        <p>
          ...
          embedding. CaptionScroll focuses on the recording and caption side:
        ...
        <h2>Who CaptionScroll Is For</h2>
        <p>
          CaptionScroll is built for people who plan their content: educators
          ...
          read it, record it,&rdquo; CaptionScroll is designed around that exact
          flow.
        </p>

        <p className="compare-cta">
          <Link to="/signup" className="hero-cta">
            Try CaptionScroll Free
          </Link>
        </p>
      </main>
